...
<nav class="navbar navbar-expand-sm fixed-top navbar-dark shadow-down">
    <div class="container-fluid main-wrap-content">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo ROUTE_HOME; ?>#document_promociones">Promociones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"
                        href="<?php echo ROUTE_HOME; ?>#document_productos-destacados">Destacados</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo ROUTE_HOME; ?>#document_categoria-ninos">Niños</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo ROUTE_HOME; ?>#document_categoria-damas">Damas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"
                        href="<?php echo ROUTE_HOME; ?>#document_categoria-caballeros">Caballeros</a>
                </li>
            </ul>
            <div class="d-flex">
